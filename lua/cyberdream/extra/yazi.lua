...
marker_selected = { bg = "${bh_highlight}", fg = "${green}" }
preview_hovered = { bg = "${bh_highlight}", bold = true, fg = "${fg}" }
tab_active = { bg = "${blue}", fg = "${bg}" }
tab_inactive = { bg = "${bh_highlight}", fg = "${fg}" }
...
separator_style = { bg = "${bh_highlight}", fg = "${bh_highlight}" }
