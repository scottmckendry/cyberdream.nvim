    ...
    local template = [==[
{
    ...
    "colors": {
        ...
        "thinkingMinimal": "bgHighlight",
        "thinkingLow": "bgHighlight",
        "thinkingMedium": "bgHighlight",
        "thinkingHigh": "bgHighlight",
        "thinkingXhigh": "bgHighlight",
        "thinkingMax": "bgHighlight",
