...
function M.setup()
    ...
    theme.highlights = {
        ...
        CursorColumn = { bg = t.noneHighlight },
        CursorLine = { bg = t.noneHighlight },
        Directory = { fg = t.blue },
        DiffAdd = { fg = t.green },
        ...
        Folded = { fg = t.grey, bg = t.noneHighlight },
        FoldColumn = { fg = t.grey, bg = t.noneHighlight },
        SignColumn = { fg = t.grey, bg = t.none },
        SignColumnSB = { fg = t.grey, bg = t.none },
        Substitute = { fg = t.red, bg = t.noneHighlight },
        LineNr = { fg = t.noneHighlight },
        CursorLineNr = { fg = t.grey },
        MatchParen = { fg = t.pink, bg = t.noneHighlight },
        ModeMsg = { fg = t.fg },
        MsgArea = { fg = t.fg },
        MoreMsg = { fg = t.fg },
        NonText = { fg = t.grey },
        ...
        FloatTitle = { fg = t.fg, bg = t.noneHighlight },
        FloatBorder = { fg = t.grey, bg = t.noneHighlight },
        Pmenu = { fg = t.fg, bg = t.noneHighlight },
        PmenuSel = { fg = t.fg, bg = t.noneHighlight },
        PmenuSbar = { fg = t.none, bg = t.noneHighlight },
        PmenuThumb = { fg = t.none, bg = t.noneHighlight },
        ...
        StatusLine = { fg = t.fg, bg = t.noneHighlight },
        StatusLineNC = { fg = t.grey, bg = t.noneHighlight },
        TabLine = { fg = t.grey, bg = t.noneHighlight },
        TabLineFill = { fg = t.grey, bg = t.noneHighlight },
        TabLineSel = { fg = t.fg, bg = t.noneHighlight },
        Title = { fg = t.fg },
        ...
        LspReferenceText = { bg = t.noneHighlight },
        LspReferenceRead = { bg = t.noneHighlight },
        LspReferenceWrite = { bg = t.noneHighlight },
