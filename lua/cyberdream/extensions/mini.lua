...
function M.get(opts, t)
    ...
    local highlights = {
        ...
        MiniPickMatchMarked = { bg = t.bh_highlight },
        ...
        MiniTablineCurrent = { fg = t.fg, bg = t.bh_highlight, bold = true },
        MiniTablineFill = { link = "TabLineFill" },
        MiniTablineHidden = { fg = t.grey, bg = t.bg },
        MiniTablineModifiedCurrent = { fg = t.bh_highlight, bg = t.fg, bold = true },
        MiniTablineModifiedHidden = { fg = t.bg_solid, bg = t.grey },
        MiniTablineModifiedVisible = { fg = t.bh_highlight, bg = t.fg },
        MiniTablineTabpagesection = { link = "Search" },
        MiniTablineVisible = { fg = t.fg, bg = t.bh_highlight },
