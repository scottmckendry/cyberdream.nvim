...
function M.get(opts, t)
    ...
    local highlights = {
        ...
        MiniDiffOverAdd = { bg = util.blend(t.bg, t.green, 0.8) },
        MiniDiffOverChange = { bg = util.blend(t.bg, t.blue, 0.8) },
        MiniDiffOverContext = { bg = util.blend(t.bg, t.orange, 0.8) },
        MiniDiffOverDelete = { bg = util.blend(t.bg, t.red, 0.8) },
