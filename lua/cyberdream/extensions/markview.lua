...
function M.get(opts, t)
    ...
    local highlights = {
        ...
        MarkviewCode = { bg = util.blend(t.bg_alt, t.bh_highlight, 0.8) },
        MarkviewInlineCode = { fg = t.pink, bg = util.blend(t.bg_alt, t.bh_highlight, 0.8) },

        MarkviewTableBorder = { fg = t.bh_highlight },
